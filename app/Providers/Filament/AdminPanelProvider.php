    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->middleware([
                ...
                // Panel routes do not run the `web` group, so the locale
                // middleware has to be listed here as well. It pins /admin to
                // English regardless of the visitor's language cookie.
                SetLocale::class,
            ])
            ->authMiddleware([
                Authenticate::class,
